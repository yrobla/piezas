...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PiezasUser.phone_number'
        db.alter_column(u'customuser_piezasuser', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PiezasUser.phone_number'
        db.alter_column(u'customuser_piezasuser', 'phone_number', self.gf('oscar.models.fields.PhoneNumberField')(max_length=128))
