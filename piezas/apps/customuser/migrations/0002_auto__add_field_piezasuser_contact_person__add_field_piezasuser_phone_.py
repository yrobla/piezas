...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PiezasUser.contact_person'
        db.add_column(u'customuser_piezasuser', 'contact_person',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'PiezasUser.phone_number'
        db.add_column(u'customuser_piezasuser', 'phone_number',
                      self.gf('oscar.models.fields.PhoneNumberField')(default=1, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PiezasUser.contact_person'
        db.delete_column(u'customuser_piezasuser', 'contact_person')

        # Deleting field 'PiezasUser.phone_number'
        db.delete_column(u'customuser_piezasuser', 'phone_number')
    ...
    models = {
        ...
        u'customuser.piezasuser': {
            ...
            'phone_number': ('oscar.models.fields.PhoneNumberField', [], {'max_length': '128'}),
