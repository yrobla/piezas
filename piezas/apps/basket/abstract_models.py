...
from piezas.apps.catalogue.models import SearchProductRequest
...
class AbstractBasket(models.Model):
    ...
    owner = models.ForeignKey(
        AUTH_USER_MODEL, related_name='baskets', null=False,
    ...
    def __unicode__(self):
        return _(
            u"%(status)s search request (owner: %(owner)s, lines: %(num_lines)d)") \
            % {'status': self.status,
               'owner': self.owner,
    ...
    def _create_line_reference(self, product):
        """
...
class AbstractLine(models.Model):
    ...
    product = models.ForeignKey(
        SearchProductRequest, related_name='basket_lines',
    ...
    class Meta:
        ...
        verbose_name = _('Search request item')
        verbose_name_plural = _('Search request items')

    def __unicode__(self):
        return _(
            u"Search request #%(basket_id)d, Product #%(product_id)d, quantity"
