...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.product'
        db.alter_column(u'basket_line', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.SearchProductRequest']))

        # Changing field 'Basket.owner'
        db.alter_column(u'basket_basket', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Line.product'
        db.alter_column(u'basket_line', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))

        # Changing field 'Basket.owner'
        db.alter_column(u'basket_basket', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'baskets'", 'to': u"orm['auth.User']"}),
        ...
        u'basket.line': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basket_lines'", 'to': u"orm['catalogue.SearchProductRequest']"}),
