...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'offer_conditionaloffer', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='Open', max_length=64)),
            ...
            ('max_global_applications', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_user_applications', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_basket_applications', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('max_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('total_discount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2)),
            ('num_applications', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ...
        db.send_create_signal(u'offer', ['ConditionalOffer'])

        # Adding model 'Condition'
        db.create_table(u'offer_condition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('range', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offer.Range'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('value', self.gf('oscar.models.fields.PositiveDecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('proxy_class', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'offer', ['Condition'])

        # Adding model 'Benefit'
        db.create_table(u'offer_benefit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('range', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offer.Range'], null=True, blank=True)),
        ...
        db.send_create_signal(u'offer', ['Benefit'])

        # Adding model 'Range'
        db.create_table(u'offer_range', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=128, unique=True, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal(u'offer', ['Range'])

        # Adding M2M table for field excluded_products on 'Range'
        m2m_table_name = db.shorten_name(u'offer_range_excluded_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('range', models.ForeignKey(orm[u'offer.range'], null=False)),
            ('product', models.ForeignKey(orm[u'catalogue.product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['range_id', 'product_id'])

        # Adding M2M table for field classes on 'Range'
        m2m_table_name = db.shorten_name(u'offer_range_classes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('range', models.ForeignKey(orm[u'offer.range'], null=False)),
            ('productclass', models.ForeignKey(orm[u'catalogue.productclass'], null=False))
        ))
        db.create_unique(m2m_table_name, ['range_id', 'productclass_id'])

        # Adding M2M table for field included_categories on 'Range'
        m2m_table_name = db.shorten_name(u'offer_range_included_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('range', models.ForeignKey(orm[u'offer.range'], null=False)),
            ('category', models.ForeignKey(orm[u'catalogue.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['range_id', 'category_id'])

        # Adding model 'RangeProduct'
        db.create_table(u'offer_rangeproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'offer', ['RangeProduct'])

        # Adding unique constraint on 'RangeProduct', fields ['range', 'product']
        db.create_unique(u'offer_rangeproduct', ['range_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RangeProduct', fields ['range', 'product']
        db.delete_unique(u'offer_rangeproduct', ['range_id', 'product_id'])

        # Deleting model 'ConditionalOffer'
        db.delete_table(u'offer_conditionaloffer')

        # Deleting model 'Condition'
        db.delete_table(u'offer_condition')

        # Deleting model 'Benefit'
        db.delete_table(u'offer_benefit')

        # Deleting model 'Range'
        db.delete_table(u'offer_range')

        # Removing M2M table for field excluded_products on 'Range'
        db.delete_table(db.shorten_name(u'offer_range_excluded_products'))

        # Removing M2M table for field classes on 'Range'
        db.delete_table(db.shorten_name(u'offer_range_classes'))

        # Removing M2M table for field included_categories on 'Range'
        db.delete_table(db.shorten_name(u'offer_range_included_categories'))

        # Deleting model 'RangeProduct'
        db.delete_table(u'offer_rangeproduct')
