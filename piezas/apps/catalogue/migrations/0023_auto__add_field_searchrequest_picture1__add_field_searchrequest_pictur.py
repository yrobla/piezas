...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.picture1'
        db.add_column(u'catalogue_searchrequest', 'picture1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture2'
        db.add_column(u'catalogue_searchrequest', 'picture2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture3'
        db.add_column(u'catalogue_searchrequest', 'picture3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture4'
        db.add_column(u'catalogue_searchrequest', 'picture4',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture5'
        db.add_column(u'catalogue_searchrequest', 'picture5',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture6'
        db.add_column(u'catalogue_searchrequest', 'picture6',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture7'
        db.add_column(u'catalogue_searchrequest', 'picture7',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture8'
        db.add_column(u'catalogue_searchrequest', 'picture8',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture9'
        db.add_column(u'catalogue_searchrequest', 'picture9',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.picture10'
        db.add_column(u'catalogue_searchrequest', 'picture10',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchRequest.picture1'
        db.delete_column(u'catalogue_searchrequest', 'picture1')

        # Deleting field 'SearchRequest.picture2'
        db.delete_column(u'catalogue_searchrequest', 'picture2')

        # Deleting field 'SearchRequest.picture3'
        db.delete_column(u'catalogue_searchrequest', 'picture3')

        # Deleting field 'SearchRequest.picture4'
        db.delete_column(u'catalogue_searchrequest', 'picture4')

        # Deleting field 'SearchRequest.picture5'
        db.delete_column(u'catalogue_searchrequest', 'picture5')

        # Deleting field 'SearchRequest.picture6'
        db.delete_column(u'catalogue_searchrequest', 'picture6')

        # Deleting field 'SearchRequest.picture7'
        db.delete_column(u'catalogue_searchrequest', 'picture7')

        # Deleting field 'SearchRequest.picture8'
        db.delete_column(u'catalogue_searchrequest', 'picture8')

        # Deleting field 'SearchRequest.picture9'
        db.delete_column(u'catalogue_searchrequest', 'picture9')

        # Deleting field 'SearchRequest.picture10'
        db.delete_column(u'catalogue_searchrequest', 'picture10')
    ...
    models = {
        ...
        u'catalogue.searchrequest': {
            ...
            'picture1': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture10': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture2': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture3': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture4': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture5': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture6': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture7': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture8': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture9': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '25'}),
