...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductQuestion'
        db.create_table(u'catalogue_productquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_question', to=orm['catalogue.Product'])),
        ))
        db.send_create_signal(u'catalogue', ['ProductQuestion'])


    def backwards(self, orm):
        # Deleting model 'ProductQuestion'
        db.delete_table(u'catalogue_productquestion')
