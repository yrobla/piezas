...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchItemRequest.quantity'
        db.add_column(u'catalogue_searchitemrequest', 'quantity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchItemRequest.quantity'
        db.delete_column(u'catalogue_searchitemrequest', 'quantity')
