...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductQuestion.type'
        db.add_column(u'catalogue_productquestion', 'type',
                      self.gf('django.db.models.fields.CharField')(default='boolean', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductQuestion.type'
        db.delete_column(u'catalogue_productquestion', 'type')
