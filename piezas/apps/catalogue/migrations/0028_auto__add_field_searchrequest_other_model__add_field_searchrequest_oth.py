...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.other_model'
        db.add_column(u'catalogue_searchrequest', 'other_model',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.other_version'
        db.add_column(u'catalogue_searchrequest', 'other_version',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.other_bodywork'
        db.add_column(u'catalogue_searchrequest', 'other_bodywork',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchRequest.other_engine'
        db.add_column(u'catalogue_searchrequest', 'other_engine',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchRequest.other_model'
        db.delete_column(u'catalogue_searchrequest', 'other_model')

        # Deleting field 'SearchRequest.other_version'
        db.delete_column(u'catalogue_searchrequest', 'other_version')

        # Deleting field 'SearchRequest.other_bodywork'
        db.delete_column(u'catalogue_searchrequest', 'other_bodywork')

        # Deleting field 'SearchRequest.other_engine'
        db.delete_column(u'catalogue_searchrequest', 'other_engine')
