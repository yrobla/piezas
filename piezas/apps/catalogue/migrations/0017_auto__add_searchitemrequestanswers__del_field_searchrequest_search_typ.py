...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchItemRequestAnswers'
        db.create_table(u'catalogue_searchitemrequestanswers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('search_item_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.SearchItemRequest'], null=True, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='piece_question', to=orm['catalogue.ProductQuestion'])),
            ...
            ('image_answer', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_answers', null=True, to=orm['customuser.PiezasUser'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'catalogue', ['SearchItemRequestAnswers'])

        # Deleting field 'SearchRequest.search_type'
        db.delete_column(u'catalogue_searchrequest', 'search_type')

        # Adding field 'SearchItemRequest.picture'
        db.add_column(u'catalogue_searchitemrequest', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'SearchItemRequest.piece'
        db.alter_column(u'catalogue_searchitemrequest', 'piece_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))

    def backwards(self, orm):
        # Deleting model 'SearchItemRequestAnswers'
        db.delete_table(u'catalogue_searchitemrequestanswers')

        # Adding field 'SearchRequest.search_type'
        db.add_column(u'catalogue_searchrequest', 'search_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=25),
                      keep_default=False)

        # Deleting field 'SearchItemRequest.picture'
        db.delete_column(u'catalogue_searchitemrequest', 'picture')


        # Changing field 'SearchItemRequest.piece'
        db.alter_column(u'catalogue_searchitemrequest', 'piece_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['catalogue.Product']))
    ...
    models = {
        ...
        u'catalogue.searchitemrequestanswers': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_answer': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
