...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Model.date_created'
        db.add_column(u'catalogue_model', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Model.date_update'
        db.add_column(u'catalogue_model', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 12, 0, 0), db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Engine.date_created'
        db.add_column(u'catalogue_engine', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 12, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Version.date_created'
        db.add_column(u'catalogue_version', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 12, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Bodywork.date_created'
        db.add_column(u'catalogue_bodywork', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 12, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Brand.date_created'
        db.add_column(u'catalogue_brand', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 12, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Model.date_created'
        db.delete_column(u'catalogue_model', 'date_created')

        # Deleting field 'Model.date_update'
        db.delete_column(u'catalogue_model', 'date_update')

        # Deleting field 'Engine.date_created'
        db.delete_column(u'catalogue_engine', 'date_created')

        # Deleting field 'Engine.date_update'
        db.delete_column(u'catalogue_engine', 'date_update')

        # Deleting field 'Version.date_created'
        db.delete_column(u'catalogue_version', 'date_created')

        # Deleting field 'Version.date_update'
        db.delete_column(u'catalogue_version', 'date_update')

        # Deleting field 'Bodywork.date_created'
        db.delete_column(u'catalogue_bodywork', 'date_created')

        # Deleting field 'Bodywork.date_update'
        db.delete_column(u'catalogue_bodywork', 'date_update')

        # Deleting field 'Brand.date_created'
        db.delete_column(u'catalogue_brand', 'date_created')
    ...
    models = {
        ...
        u'catalogue.bodywork': {
            ...
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'catalogue.brand': {
