...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.date_accepted'
        db.add_column(u'catalogue_quote', 'date_accepted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.date_accepted'
        db.delete_column(u'catalogue_quote', 'date_accepted')
