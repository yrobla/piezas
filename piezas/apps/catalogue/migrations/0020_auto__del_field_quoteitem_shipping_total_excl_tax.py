...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuoteItem.shipping_total_excl_tax'
        db.delete_column(u'catalogue_quoteitem', 'shipping_total_excl_tax')


    def backwards(self, orm):
        # Adding field 'QuoteItem.shipping_total_excl_tax'
        db.add_column(u'catalogue_quoteitem', 'shipping_total_excl_tax',
