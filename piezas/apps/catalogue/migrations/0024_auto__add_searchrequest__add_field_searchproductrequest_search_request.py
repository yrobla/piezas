...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_searchrequest', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_rqeuests', null=True, to=orm['auth.User'])),
        ...
        # Adding field 'SearchProductRequest.search_request'
        db.add_column(u'catalogue_searchproductrequest', 'search_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.SearchRequest'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SearchProductRequest.search_request'
        db.delete_column(u'catalogue_searchproductrequest', 'search_request_id')
    ...
    models = {
        ...
        u'catalogue.searchrequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_rqeuests'", 'null': 'True', 'to': u"orm['auth.User']"}),
