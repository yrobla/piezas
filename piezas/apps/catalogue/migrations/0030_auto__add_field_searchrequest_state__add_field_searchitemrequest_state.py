...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.state'
        db.add_column(u'catalogue_searchrequest', 'state',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=25),
                      keep_default=False)

        # Adding field 'SearchItemRequest.state'
        db.add_column(u'catalogue_searchitemrequest', 'state',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=25),
                      keep_default=False)


        # Changing field 'SearchItemRequest.category'
        db.alter_column(u'catalogue_searchitemrequest', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Category']))

        # Changing field 'SearchItemRequest.piece'
        db.alter_column(u'catalogue_searchitemrequest', 'piece_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(default=1, to=orm['catalogue.Product']))

    def backwards(self, orm):
        # Deleting field 'SearchRequest.state'
        db.delete_column(u'catalogue_searchrequest', 'state')

        # Deleting field 'SearchItemRequest.state'
        db.delete_column(u'catalogue_searchitemrequest', 'state')


        # Changing field 'SearchItemRequest.category'
        db.alter_column(u'catalogue_searchitemrequest', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Category']))

        # Changing field 'SearchItemRequest.piece'
        db.alter_column(u'catalogue_searchitemrequest', 'piece_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(null=True, to=orm['catalogue.Product']))
