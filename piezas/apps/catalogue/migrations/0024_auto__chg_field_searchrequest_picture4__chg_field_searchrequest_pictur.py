...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SearchRequest.picture4'
        db.alter_column(u'catalogue_searchrequest', 'picture4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture10'
        db.alter_column(u'catalogue_searchrequest', 'picture10', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture8'
        db.alter_column(u'catalogue_searchrequest', 'picture8', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture9'
        db.alter_column(u'catalogue_searchrequest', 'picture9', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture2'
        db.alter_column(u'catalogue_searchrequest', 'picture2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture1'
        db.alter_column(u'catalogue_searchrequest', 'picture1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture6'
        db.alter_column(u'catalogue_searchrequest', 'picture6', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture7'
        db.alter_column(u'catalogue_searchrequest', 'picture7', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture5'
        db.alter_column(u'catalogue_searchrequest', 'picture5', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SearchRequest.picture3'
        db.alter_column(u'catalogue_searchrequest', 'picture3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'SearchRequest.picture4'
        db.alter_column(u'catalogue_searchrequest', 'picture4', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture10'
        db.alter_column(u'catalogue_searchrequest', 'picture10', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture8'
        db.alter_column(u'catalogue_searchrequest', 'picture8', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture9'
        db.alter_column(u'catalogue_searchrequest', 'picture9', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture2'
        db.alter_column(u'catalogue_searchrequest', 'picture2', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture1'
        db.alter_column(u'catalogue_searchrequest', 'picture1', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture6'
        db.alter_column(u'catalogue_searchrequest', 'picture6', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture7'
        db.alter_column(u'catalogue_searchrequest', 'picture7', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture5'
        db.alter_column(u'catalogue_searchrequest', 'picture5', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'SearchRequest.picture3'
        db.alter_column(u'catalogue_searchrequest', 'picture3', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'catalogue.productquestion': {
            'Meta': {'object_name': 'ProductQuestion'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'options': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_question'", 'to': u"orm['catalogue.Product']"}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'boolean'", 'max_length': '25'})
        },
        ...
        u'catalogue.quote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quote_owner'", 'null': 'True', 'to': u"orm['customuser.PiezasUser']"}),
        ...
        u'catalogue.quoteitem': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quote_item_owner'", 'null': 'True', 'to': u"orm['customuser.PiezasUser']"}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'quote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Quote']"}),
        ...
        u'catalogue.searchitemrequest': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_product_requests'", 'null': 'True', 'to': u"orm['customuser.PiezasUser']"}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'piece': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_piece'", 'to': u"orm['catalogue.Product']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'search_request': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.SearchRequest']", 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '25'})
        },
        u'catalogue.searchitemrequestanswers': {
            'Meta': {'object_name': 'SearchItemRequestAnswers'},
            'boolean_answer': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_answer': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_answers'", 'null': 'True', 'to': u"orm['customuser.PiezasUser']"}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'piece_question'", 'to': u"orm['catalogue.ProductQuestion']"}),
            'search_item_request': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.SearchItemRequest']", 'null': 'True', 'blank': 'True'}),
        ...
        u'catalogue.searchrequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '40', 'decimal_places': '20'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '40', 'decimal_places': '20'}),
            'model': ('smart_selects.db_fields.ChainedForeignKey', [], {'blank': 'True', 'related_name': "'product_model'", 'null': 'True', 'to': u"orm['catalogue.Model']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_requests'", 'null': 'True', 'to': u"orm['customuser.PiezasUser']"}),
            'picture1': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture10': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture2': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture3': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture4': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture5': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture6': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture7': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture8': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'picture9': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '25'}),
