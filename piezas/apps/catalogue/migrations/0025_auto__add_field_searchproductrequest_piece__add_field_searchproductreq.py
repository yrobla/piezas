...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchProductRequest.piece'
        db.add_column(u'catalogue_searchproductrequest', 'piece',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_piece', null=True, to=orm['catalogue.Product']),
                      keep_default=False)

        # Adding field 'SearchProductRequest.owner'
        db.add_column(u'catalogue_searchproductrequest', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_product_requests', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'SearchProductRequest.date_created'
        db.add_column(u'catalogue_searchproductrequest', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SearchProductRequest.date_updated'
        db.add_column(u'catalogue_searchproductrequest', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 17, 0, 0), db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchProductRequest.piece'
        db.delete_column(u'catalogue_searchproductrequest', 'piece_id')

        # Deleting field 'SearchProductRequest.owner'
        db.delete_column(u'catalogue_searchproductrequest', 'owner_id')

        # Deleting field 'SearchProductRequest.date_created'
        db.delete_column(u'catalogue_searchproductrequest', 'date_created')

        # Deleting field 'SearchProductRequest.date_updated'
        db.delete_column(u'catalogue_searchproductrequest', 'date_updated')
    ...
    models = {
        ...
        u'catalogue.searchproductrequest': {
            'Meta': {'object_name': 'SearchProductRequest'},
