...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.name'
        db.add_column(u'catalogue_searchrequest', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchRequest.name'
        db.delete_column(u'catalogue_searchrequest', 'name')
