...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchProductRequest.comments'
        db.add_column(u'catalogue_searchproductrequest', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchProductRequest.comments'
        db.delete_column(u'catalogue_searchproductrequest', 'comments')
