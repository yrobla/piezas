...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuoteItem.quote'
        db.add_column(u'catalogue_quoteitem', 'quote',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Quote']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuoteItem.quote'
        db.delete_column(u'catalogue_quoteitem', 'quote_id')
