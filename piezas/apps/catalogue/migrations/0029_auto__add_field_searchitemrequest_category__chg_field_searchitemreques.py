...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchItemRequest.category'
        db.add_column(u'catalogue_searchitemrequest', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_category', null=True, to=orm['catalogue.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SearchItemRequest.category'
        db.delete_column(u'catalogue_searchitemrequest', 'category_id')


        # Changing field 'SearchItemRequest.piece'
        db.alter_column(u'catalogue_searchitemrequest', 'piece_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Product']))
    ...
    models = {
        ...
        u'catalogue.searchitemrequest': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'product_category'", 'null': 'True', 'to': u"orm['catalogue.Category']"}),
            ...
            'piece': ('smart_selects.db_fields.ChainedForeignKey', [], {'blank': 'True', 'related_name': "'product_piece'", 'null': 'True', 'to': u"orm['catalogue.Product']"}),
