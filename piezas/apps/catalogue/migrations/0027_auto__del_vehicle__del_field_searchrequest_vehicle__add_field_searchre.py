...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SearchRequest.brand'
        db.add_column(u'catalogue_searchrequest', 'brand',
        ...
        # Adding field 'SearchRequest.model'
        db.add_column(u'catalogue_searchrequest', 'model',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(blank=True, related_name='product_model', null=True, to=orm['catalogue.Model']),
                      keep_default=False)

        # Adding field 'SearchRequest.version'
        db.add_column(u'catalogue_searchrequest', 'version',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(blank=True, related_name='product_version', null=True, to=orm['catalogue.Version']),
                      keep_default=False)

        # Adding field 'SearchRequest.bodywork'
        db.add_column(u'catalogue_searchrequest', 'bodywork',
        ...
        # Adding field 'SearchRequest.engine'
        db.add_column(u'catalogue_searchrequest', 'engine',
        ...
        # Adding field 'SearchRequest.comments'
        db.add_column(u'catalogue_searchrequest', 'comments',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'catalogue_searchrequest', 'vehicle',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_vehicle', null=True, to=orm['catalogue.Vehicle'], blank=True),
                      keep_default=False)

        # Deleting field 'SearchRequest.brand'
        db.delete_column(u'catalogue_searchrequest', 'brand_id')

        # Deleting field 'SearchRequest.model'
        db.delete_column(u'catalogue_searchrequest', 'model_id')

        # Deleting field 'SearchRequest.version'
        db.delete_column(u'catalogue_searchrequest', 'version_id')

        # Deleting field 'SearchRequest.bodywork'
        db.delete_column(u'catalogue_searchrequest', 'bodywork_id')

        # Deleting field 'SearchRequest.engine'
        db.delete_column(u'catalogue_searchrequest', 'engine_id')

        # Deleting field 'SearchRequest.comments'
        db.delete_column(u'catalogue_searchrequest', 'comments')
