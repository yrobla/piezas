...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductQuestion.options'
        db.add_column(u'catalogue_productquestion', 'options',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductQuestion.options'
        db.delete_column(u'catalogue_productquestion', 'options')
