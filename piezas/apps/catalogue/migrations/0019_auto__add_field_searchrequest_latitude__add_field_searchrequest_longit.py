...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.latitude'
        db.add_column(u'catalogue_searchrequest', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=40, decimal_places=20),
                      keep_default=False)

        # Adding field 'SearchRequest.longitude'
        db.add_column(u'catalogue_searchrequest', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=40, decimal_places=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchRequest.latitude'
        db.delete_column(u'catalogue_searchrequest', 'latitude')

        # Deleting field 'SearchRequest.longitude'
        db.delete_column(u'catalogue_searchrequest', 'longitude')
