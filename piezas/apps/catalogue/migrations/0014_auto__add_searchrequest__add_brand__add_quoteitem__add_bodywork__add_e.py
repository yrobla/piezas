...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_searchrequest', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_requests', null=True, to=orm['customuser.PiezasUser'])),
        ...
        db.create_table(u'catalogue_quoteitem', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_item_owner', null=True, to=orm['customuser.PiezasUser'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
        ...
        db.create_table(u'catalogue_quote', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quote_owner', null=True, to=orm['customuser.PiezasUser'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='pending', max_length=25)),
            ('base_total_excl_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
        ...
        db.create_table(u'catalogue_searchitemrequest', (
            ...
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_product_requests', null=True, to=orm['customuser.PiezasUser'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
