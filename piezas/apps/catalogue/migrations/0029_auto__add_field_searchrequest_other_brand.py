...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchRequest.other_brand'
        db.add_column(u'catalogue_searchrequest', 'other_brand',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchRequest.other_brand'
        db.delete_column(u'catalogue_searchrequest', 'other_brand')
