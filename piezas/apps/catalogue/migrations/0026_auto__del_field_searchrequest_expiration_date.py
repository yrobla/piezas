...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SearchRequest.expiration_date'
        db.delete_column(u'catalogue_searchrequest', 'expiration_date')


    def backwards(self, orm):
        # Adding field 'SearchRequest.expiration_date'
        db.add_column(u'catalogue_searchrequest', 'expiration_date',
