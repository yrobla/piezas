...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Engine.version'
        db.add_column(u'catalogue_engine', 'version',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalogue.Version']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Engine.version'
        db.delete_column(u'catalogue_engine', 'version_id')
