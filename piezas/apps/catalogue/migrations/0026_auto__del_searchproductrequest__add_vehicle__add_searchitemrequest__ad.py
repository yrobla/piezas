...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SearchProductRequest'
        db.delete_table(u'catalogue_searchproductrequest')

        # Adding model 'Vehicle'
        db.create_table(u'catalogue_vehicle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Model'])),
            ('engine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Engine'])),
            ('bodywork', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Bodywork'])),
        ...
        db.send_create_signal(u'catalogue', ['Vehicle'])

        # Adding model 'SearchItemRequest'
        db.create_table(u'catalogue_searchitemrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('piece', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_piece', null=True, to=orm['catalogue.Product'])),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_product_requests', null=True, to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_index=True, blank=True)),
        ...
        # Adding field 'SearchRequest.vehicle'
        db.add_column(u'catalogue_searchrequest', 'vehicle',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_vehicle', null=True, to=orm['catalogue.Vehicle']),
                      keep_default=False)

        # Adding field 'SearchRequest.frameref'
        db.add_column(u'catalogue_searchrequest', 'frameref',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'SearchProductRequest'
        db.create_table(u'catalogue_searchproductrequest', (
            ('engine', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_engine', null=True, to=orm['catalogue.Engine'], blank=True)),
            ('version', self.gf('smart_selects.db_fields.ChainedForeignKey')(related_name='product_version', null=True, to=orm['catalogue.Version'], blank=True)),
            ...
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_brand', null=True, to=orm['catalogue.Brand'], blank=True)),
            ('search_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.SearchRequest'], null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_product_requests', null=True, to=orm['auth.User'])),
            ('bodywork', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_bodywork', null=True, to=orm['catalogue.Bodywork'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('model', self.gf('smart_selects.db_fields.ChainedForeignKey')(related_name='product_model', null=True, to=orm['catalogue.Model'], blank=True)),
            ('piece', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_piece', null=True, to=orm['catalogue.Product'], blank=True)),
        ))
        db.send_create_signal(u'catalogue', ['SearchProductRequest'])

        # Deleting model 'Vehicle'
        db.delete_table(u'catalogue_vehicle')

        # Deleting model 'SearchItemRequest'
        db.delete_table(u'catalogue_searchitemrequest')

        # Deleting field 'SearchRequest.vehicle'
        db.delete_column(u'catalogue_searchrequest', 'vehicle_id')

        # Deleting field 'SearchRequest.frameref'
        db.delete_column(u'catalogue_searchrequest', 'frameref')
    ...
    models = {
        ...
        u'catalogue.searchitemrequest': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_product_requests'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'piece': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'product_piece'", 'null': 'True', 'to': u"orm['catalogue.Product']"}),
        ...
        u'catalogue.searchrequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'search_requests'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'search_type': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'vehicle': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'product_vehicle'", 'null': 'True', 'to': u"orm['catalogue.Vehicle']"})
        },
        u'catalogue.vehicle': {
            'Meta': {'object_name': 'Vehicle'},
            'bodywork': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Bodywork']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'engine': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Engine']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'version': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Model']"})
        },
        u'catalogue.version': {
