...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PromotionalCode'
        db.create_table(u'catalogue_promotionalcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'catalogue', ['PromotionalCode'])


    def backwards(self, orm):
        # Deleting model 'PromotionalCode'
        db.delete_table(u'catalogue_promotionalcode')
