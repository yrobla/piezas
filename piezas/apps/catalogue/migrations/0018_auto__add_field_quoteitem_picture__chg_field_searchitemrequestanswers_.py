...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuoteItem.picture'
        db.add_column(u'catalogue_quoteitem', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'SearchItemRequestAnswers.image_answer'
        db.alter_column(u'catalogue_searchitemrequestanswers', 'image_answer', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'QuoteItem.picture'
        db.delete_column(u'catalogue_quoteitem', 'picture')


        # Changing field 'SearchItemRequestAnswers.image_answer'
        db.alter_column(u'catalogue_searchitemrequestanswers', 'image_answer', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
