...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAddress.latitude'
        db.alter_column(u'address_useraddress', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=40, decimal_places=20))

        # Changing field 'UserAddress.longitude'
        db.alter_column(u'address_useraddress', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=40, decimal_places=20))

    def backwards(self, orm):

        # Changing field 'UserAddress.latitude'
        db.alter_column(u'address_useraddress', 'latitude', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserAddress.longitude'
        db.alter_column(u'address_useraddress', 'longitude', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'address.useraddress': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'addresses'", 'to': u"orm['customuser.PiezasUser']"})
        },
        u'auth.group': {
