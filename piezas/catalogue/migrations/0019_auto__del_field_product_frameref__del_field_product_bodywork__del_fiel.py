...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'catalogue_product', 'bodywork',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_bodywork', null=True, to=orm['catalogue.Bodywork'], blank=True),
                      keep_default=False)

        # Adding field 'Product.version'
        db.add_column(u'catalogue_product', 'version',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_version', null=True, to=orm['catalogue.Version'], blank=True),
                      keep_default=False)

        # Adding field 'Product.engine'
        db.add_column(u'catalogue_product', 'engine',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_engine', null=True, to=orm['catalogue.Engine'], blank=True),
                      keep_default=False)

        # Adding field 'Product.brand'
        db.add_column(u'catalogue_product', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_brand', null=True, to=orm['catalogue.Brand'], blank=True),
                      keep_default=False)

        # Adding field 'Product.model'
        db.add_column(u'catalogue_product', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_model', null=True, to=orm['catalogue.Brand'], blank=True),
                      keep_default=False)
